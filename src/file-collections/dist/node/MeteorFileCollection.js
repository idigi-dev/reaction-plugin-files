...
var _FileCollection = _interopRequireDefault(require("../common/FileCollection")); // Built-in Node package
...
class MeteorFileCollection extends _FileCollection.default {
  ...
  constructor(name, options) {
    const { allowInsert, allowUpdate, allowRemove, check, collection, DDP } = options,opts = (0, _objectWithoutProperties2.default)(options, ["allowInsert", "allowUpdate", "allowRemove", "check", "collection", "DDP"]);
